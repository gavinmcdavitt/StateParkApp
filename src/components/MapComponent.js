...
import { getObjects, setAllParksOpen } from '../components/readDatabase'; // Adjust path as needed
...
const shadowOnlyFlowerIcon =L.icon({
    ...
    getObjects((objects) => {
        ...
        objects.forEach(obj => {
            ...
            if (obj.latitude && obj.longitude) {
                ...
                if(15 < obj.capacity && obj.capacity <= 23 && obj.isOpen)
                {
                    //yelllow
                    icon = halwayOpenPark;
                    addMarkerStatePark(
